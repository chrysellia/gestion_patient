...
public class FactureController {
	...
	private void addItem() {
		//Prendre les �l�ments du tableau m�dicament
		...
		//Ajouter des �l�ments dans le tableau facture
	...
	public void saveFacture() {
		// 1- Insertion de la facture qui va contenir le d�tail g�n�ral*
		int lastInsertId = 0;
		try {
			Database db = new Database();
		...
		// 2- Insertion de chaque m�dicament prescrit avec la designation, le prix, la quantite, sous-total et le prix unitaire
		try {
			for (int i = 0; i < lignesFacture.size(); i++) {
				FactureContenu item = lignesFacture.get(i);
